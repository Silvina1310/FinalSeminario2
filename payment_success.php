						...
						<div class="navbar navbar-inverse navbar-fixed-top">
							<div class="container-fluid">	
								...
								<ul class="nav navbar-nav">
									...
									<li><a href="profile.php"><span class="glyphicon glyphicon-modal-window"></span>Nosotros</a></li>
								</ul>
							</div>
						</div>
						<p><br/></p>
								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<h1>Gracias! </h1>  
											<p>Hello <?php echo "<b>".$_SESSION["name"]."</b>"; ?>,Tu proceso de pago se     
											completó con éxito y tu número de transacción es: <b><?php echo $trx_id; ?></b><br/>
